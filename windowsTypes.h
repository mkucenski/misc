...
static coded_message_t FILE_ATTRIBUTES[] = {
	...
	{"FILE_ATTRIBUTE_COMPRESSED",				0x800,	"", "COMPRESSED"},
	{"FILE_ATTRIBUTE_DEVICE",					0x40,		"", "DEVICE"},
	{"FILE_ATTRIBUTE_DIRECTORY",				0x10,		"", "DIRECTORY"},
	{"FILE_ATTRIBUTE_ENCRYPTED",				0x4000,	"", "ENCRYPTED"},
	{"FILE_ATTRIBUTE_HIDDEN",					0x2,		"", "HIDDEN"},
	{"FILE_ATTRIBUTE_INTEGRITY_STREAM",		0x8000,	"", "INTEGRITY_STREAM"},
	{"FILE_ATTRIBUTE_NORMAL",					0x80,		"", "NORMAL"},
	{"FILE_ATTRIBUTE_NOT_CONTENT_INDEXED",	0x2000,	"", "NOT_CONTENT_INDEXED"},
	{"FILE_ATTRIBUTE_NO_SCRUB_DATA",			0x20000,	"", "NO_SCRUB_DATA"},
	{"FILE_ATTRIBUTE_OFFLINE",					0x1000,	"", "OFFLINE"},
	{"FILE_ATTRIBUTE_READONLY",				0x1,		"", "READONLY"},
	{"FILE_ATTRIBUTE_REPARSE_POINT",			0x400,	"", "REPARSE_POINT"},
	{"FILE_ATTRIBUTE_SPARSE_FILE",			0x200,	"", "SPARSE_FILE"},
	{"FILE_ATTRIBUTE_SYSTEM",					0x4,		"", "SYSTEM"},
	{"FILE_ATTRIBUTE_TEMPORARY",				0x100,	"", "TEMPORARY"},
	{"FILE_ATTRIBUTE_VIRTUAL",					0x10000,	"", "VIRTUAL"}
};
